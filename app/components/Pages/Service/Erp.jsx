  ...
  return (
    <div>
      <Helmet>
        ...
        <meta
          name="description"
          content="Excerpt Technologies Private Limited offers comprehensive ERP System solutions to streamline business processes and improve operational efficiency."
        />
      </Helmet>
      ...
      >
        <div className="container">
          <div className="page-info">
            <h2 className="heading-2" style={{ color: "white", textAlign: "center" }}>ERP Systems</h2>
            <h6 className="heading-6">
              <Link href="/">Home</Link> / <span>ERP Systems</span>
            </h6>
          </div>
