                ...
                >
                  ...
                  {slide.useGradient ? (
                    ...
                    <div className="slide-content-wrapper">
                      ...
                      >
                        <h2 className="heading-2 mb-25 slide-caption-desktop" style={{ color: 'white', fontWeight: '700',fontSize:'2.5rem' }}>
                          {slide.caption}
                        </h2>
                        <h1 className="slide-subtitle-desktop" style={{ color: 'white', fontWeight: '600', marginBottom: '20px' }}>
                          IT Solutions
                    ...
                    >
                      <h2 className="heading-2 mb-25 slide-caption-desktop" style={{ color: 'white' ,fontSize:'2.5rem'}}>
                        {slide.caption}
                      </h2>
                      <h1 className="slide-subtitle-desktop" style={{color:"white"}}>IT Solutions</h1>
                      <div className="heading-5 mb-30 slide-description-desktop" style={{ color: 'white', fontSize:'1.2rem'}}>
                        Innovative Solutions, Seamless Experiences.
                      </div>
                      {slide.caption === 'IT Corporate Training' ? (
                        <Link
